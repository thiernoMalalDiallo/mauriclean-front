...
var SubscribeManagemmentPageModule = /** @class */ (function () {
    function SubscribeManagemmentPageModule() {
    }
    ...
    return SubscribeManagemmentPageModule;
}());
...
var SubscribeManagemmentPage = /** @class */ (function () {
    function SubscribeManagemmentPage(modal, observableProvider, route, utils, session, abonnementProvider) {
        this.modal = modal;
    ...
    SubscribeManagemmentPage.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.observableProvider.loadAbonnement.subscribe(function (load) {
            if (load) {
                _this.subscribes = [];
                _this.subscribesTmp = [];
                _this.limit = 14;
                _this.skip = 0;
                _this.getSubscribesByFilter();
            }
        });
        this.route.queryParams.subscribe(function (params) {
            if (params && params.adresses && params.user) {
                ...
                _this.modal.create(_components_africlean_adress_africlean_adress_component__WEBPACK_IMPORTED_MODULE_4__["AfricleanAdressComponent"], 'my-custom-modal-css', props);
            }
        });
        // On appel la modal pour saisir une adresse
    };
    SubscribeManagemmentPage.prototype.sendPosition = function (position) {
    ...
    SubscribeManagemmentPage.prototype.getSubscribesByFilter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var user, entity, id, body, customerType, url;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        body = {};
                        customerType = this.utils.getCustomerType(this.customerType);
                        body = {
                            limit: this.limit,
                            skip: this.skip,
                        ...
                        console.log(body);
                        url = 'abonnement/subscribes';
                        this.abonnementProvider.save(url, body).subscribe(function (subscribes) {
                            var subscribe = _this._filter(customerType, subscribes);
                            if (!_this.subscribes && !_this.subscribesTmp) {
                                _this.subscribes = [];
                                _this.subscribesTmp = [];
                                _this.positions = [];
                            }
                            _this.subscribes = _this.subscribes.concat(subscribe.slice());
                            _this.subscribesTmp = _this.subscribesTmp.concat(subscribe.slice());
                        });
                        return [2 /*return*/];
                }
            });
    ...
    SubscribeManagemmentPage.prototype._filter = function (value, list) {
        var filterValue = value.toString();
        return list.filter(function (item) { return item.user.customerType.toString().indexOf(filterValue) === 0; });
    };
    SubscribeManagemmentPage.prototype.segmentChanged = function (ev) {
        this.limit = 14;
        this.skip = 0;
        this.subscribes = [];
        this.subscribesTmp = [];
    ...
    SubscribeManagemmentPage.ctorParameters = function () { return [
    ...
    return SubscribeManagemmentPage;
}());
...
//# sourceMappingURL=pages-manager-subscribe-managemment-subscribe-managemment-module-es5.js.map