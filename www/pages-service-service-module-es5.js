...
var ServicePage = /** @class */ (function () {
    function ServicePage(interventionProvider, session, observableProvider) {
    ...
    ServicePage.prototype.toggleIntervention = function (event) {
        this.interventionCheck = event.detail.checked;
    };
    ServicePage.prototype.toggleDashboard = function (event) {
        this.dashboardInterventionCheck = event.detail.checked;
    };
    ServicePage.prototype.sendPosition = function (position) {
    ...
    ServicePage.prototype.getInterventionsByFilter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var userId, url, _a, body;
            var _this = this;
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        this.interventionProvider.save(url, body).subscribe(function (interventions) {
                            var interventionList = interventions.reverse();
    ...
    ServicePage.ctorParameters = function () { return [
