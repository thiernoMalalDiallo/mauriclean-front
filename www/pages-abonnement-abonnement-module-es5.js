...
var AbonnementPage = /** @class */ (function () {
    function AbonnementPage(modal, httpSubscribe, observablesProvider, payementProvider, session, config) {
        this.modal = modal;
    ...
    AbonnementPage.prototype.ngOnInit = function () {
        ...
        this.observablesProvider.loadPayement.subscribe(function (result) {
            _this.payements = [];
            _this.payementsTMP = [];
            _this.positions = [];
     ...
     */
    AbonnementPage.prototype.getUser = function () {
    ...
    AbonnementPage.prototype.sendPosition = function (position) {
     ...
     * Liste de payement
     */
    AbonnementPage.prototype.getPayements = function (typePayement) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, _b, body, url;
            var _this = this;
