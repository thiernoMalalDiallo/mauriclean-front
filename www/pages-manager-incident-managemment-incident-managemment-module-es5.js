...
var IncidentManagemmentPageModule = /** @class */ (function () {
    function IncidentManagemmentPageModule() {
    }
    ...
    return IncidentManagemmentPageModule;
}());
...
var IncidentManagemmentPage = /** @class */ (function () {
    function IncidentManagemmentPage(observableProvider, modal, session, incidentProvider, route) {
    ...
    IncidentManagemmentPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    IncidentManagemmentPage.prototype.sendPosition = function (position) {
    ...
    IncidentManagemmentPage.prototype.getIncidentsByFilter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var user, body, userId, url, _a;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a.role = _b.sent();
                        if (!(this.role === _providers_utils_commonEnum__WEBPACK_IMPORTED_MODULE_8__["UserRole"].CLIENT)) return [3 /*break*/, 4];
    ...
    IncidentManagemmentPage.prototype.addIncident = function () {
        var props = {
    ...
    IncidentManagemmentPage.ctorParameters = function () { return [
    ...
    return IncidentManagemmentPage;
}());
...
//# sourceMappingURL=pages-manager-incident-managemment-incident-managemment-module-es5.js.map