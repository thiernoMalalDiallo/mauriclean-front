...
var FinanceManagementPageModule = /** @class */ (function () {
    function FinanceManagementPageModule() {
    }
    ...
    return FinanceManagementPageModule;
}());
...
var FinanceManagementPage = /** @class */ (function () {
    function FinanceManagementPage(session, payementProvider, dateProvider, observableProvider, config) {
    ...
    FinanceManagementPage.prototype.ngOnInit = function () {
        var _this = this;
        this.getUser();
        this.isWeb = this.config.isWeb();
        this.observableProvider.loadPayement.subscribe(function (result) {
            _this.payements = [];
            _this.payementsTMP = [];
            _this.positions = [];
            _this.getPayements('abonnement');
        });
        this.observableProvider.loadPayementEmploye.subscribe(function (result) {
            _this.payementsEmploye = [];
            _this.payementsTMPEmploye = [];
            _this.positionsEmploye = [];
            _this.getPayements('employe');
        });
    };
    /**
     * Utilisateur temporaire
     */
    FinanceManagementPage.prototype.getUser = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        _b.userId = _d.sent();
                        _c = this;
                        return [4 /*yield*/, this.session.getItem('userTMP')];
                    case 3:
                        _c.userTMP = _d.sent();
     ...
     */
    FinanceManagementPage.prototype.togglePaySubscription = function (event) {
     ...
     */
    FinanceManagementPage.prototype.togglePayeEmploye = function (event) {
    ...
    FinanceManagementPage.prototype.sendPosition = function (position) {
     ...
     * Liste de payement
     */
    FinanceManagementPage.prototype.getPayements = function (typePayement) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var body, url, _a, _b;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        this.payementProvider.postPaiment(url, body).subscribe(function (payementList) {
                            if (!_this.payements && !_this.payementsTMP) {
                                _this.payements = [];
                                _this.payementsTMP = [];
                                _this.positions = [];
                            }
                            if (!_this.payementsEmploye && !_this.payementsTMPEmploye) {
                                _this.payementsEmploye = [];
                                _this.payementsTMPEmploye = [];
                                _this.positionsEmploye = [];
                            }
                            ...
                            if (typePayement === 'abonnement') {
                                _this.payements = _this.payements.concat(payementList.slice());
                                _this.payementsTMP = _this.payementsTMP.concat(payementList.slice());
                            }
                            else {
                                _this.payementsEmploye = _this.payementsEmploye.concat(payementList.slice());
                                _this.payementsTMPEmploye = _this.payementsTMPEmploye.concat(payementList.slice());
                            }
                            /*  } else {
    ...
    FinanceManagementPage.prototype.sendPositionEmploye = function (position) {
    ...
    FinanceManagementPage.prototype._filter = function (name, list) {
        var filterValue = name.toLowerCase();
        // tslint:disable-next-line:max-line-length
        return list.filter(function (item) { return (item.payement.payementCreatedAuthorId.authorId.toLowerCase().indexOf(filterValue) === 0); });
    };
    FinanceManagementPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-manager-finance-management-finance-management-module-es5.js.map