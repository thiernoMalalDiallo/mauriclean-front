...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, session, alert, config, observableProvider, userHttp) {
    ...
    HomePage.prototype.ngOnInit = function () {
        ...
        this.observableProvider.isAuth.subscribe(function (isAuth) {
            _this.getUser();
        });
        // Test la platforme
    ...
    HomePage.prototype.isSubscribe = function (page) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var role, login, body, isSubscribe;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.session.getItem('role')];
                    case 1:
                        role = _a.sent();
                        if (!(role === _providers_utils_commonEnum__WEBPACK_IMPORTED_MODULE_8__["UserRole"].CLIENT)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.session.getItem('login')];
                    case 2:
                        login = _a.sent();
                        body = {
                            phoneNumber: login
                        ...
                        if (page !== 'consult-abonnement' && page !== 'consult-informations') {
                            isSubscribe = this.user.isSubscribe;
