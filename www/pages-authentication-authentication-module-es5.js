...
/* harmony import */ var ng2_tel_input__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ng2-tel-input */ "./node_modules/ng2-tel-input/esm5/ng2-tel-input.js");
...
var AuthenticationPage = /** @class */ (function () {
     ...
     */
    function AuthenticationPage(navCtrl, controlField, translateService, httpUser, route, session, observableProvider, websocket, config, modal) {
    ...
    AuthenticationPage.prototype.forgotPassword = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.modal.create(src_app_components_africlean_forgot_password_africlean_forgot_password_component__WEBPACK_IMPORTED_MODULE_11__["AfricleanForgotPasswordComponent"], 'my-custom-modal-css')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.session.setItem('userId', user.id)];
                    case 2:
                        _a.sent();
    ...
    AuthenticationPage.prototype.goToHome = function (userLog) {
        ...
        if (userLog.length > 0) {
            var role = userLog[0].role;
            // Dans le cas ou l'utilisateur à un seul compte
            if (userLog.length === 1) {
                var user = userLog[0].user;
                this.setSessionVariables(user, role).then(function (_) {
                    // Signale une nouvelle session
                    _this.observableProvider.isAuth.emit(true);
                    _this.navCtrl.navigateForward('home');
                });
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.websocket.receive('user_state').subscribe(function (res) {
                        });
                        return [2 /*return*/];
                }
            });
    ...
    AuthenticationPage.prototype._filter = function (value, list) {
        var filterValue = value;
        return list.filter(function (option) { return option.dialCode.indexOf(filterValue) === 0; });
    };
    AuthenticationPage.prototype.telInputObject = function (obj) {
        var list = obj.p;
        var country = this._filter(this.phoneCode.replace('+', ''), list);
        if (country.length > 0) {
            obj.setCountry(country[0].iso2);
            this.phoneCode = country[0].dialCode;
        }
    };
    AuthenticationPage.prototype.getNumber = function (event) {
    };
    AuthenticationPage.prototype.onCountryChange = function (event) {
