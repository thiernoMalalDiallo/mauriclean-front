...
let InterventionPage = class InterventionPage {
     ...
     */
    constructor(interventionProvider, session, userProvider, observableProvider) {
    ...
    ngOnInit() {
        ...
        this.observableProvider.loadIntervention.subscribe((loadIncident) => {
            if (loadIncident) {
                this.limit = 10;
                this.skip = 0;
                this.showAddFormuler = false;
        ...
        this.observableProvider.showClientsSelection.subscribe((result) => {
    ...
    getInterventionsByFilter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.interventionProvider.save(url, body).subscribe((interventions) => {
                const interventionList = interventions.slice();
...
//# sourceMappingURL=pages-intervenant-intervention-intervention-module-es2015.js.map