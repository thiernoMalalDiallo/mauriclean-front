...
var ProspectionPageModule = /** @class */ (function () {
    function ProspectionPageModule() {
    }
...
var ProspectionPage = /** @class */ (function () {
    function ProspectionPage(prospectionProvider, observableProvider, session) {
    ...
    ProspectionPage.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.observableProvider.loadProspection.subscribe(function (load) {
            if (load) {
                _this.limit = 14;
                _this.skip = 0;
                _this.prospections = [];
                _this.prospectionsTmp = [];
                _this.positions = [];
                _this.getProspectionssByFilter();
            }
        });
    };
    ProspectionPage.prototype.toggleProspection = function (event) {
        this.prospectionCheck = event.detail.checked;
    };
    ProspectionPage.prototype.toggleDashboard = function (event) {
        this.dashboardProspectionCheck = event.detail.checked;
    };
    ProspectionPage.prototype.sendPosition = function (position) {
     ...
     */
    ProspectionPage.prototype.getProspectionssByFilter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var userId, roleAuthor, url, body, body, url;
            var _this = this;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (roleAuthor === _providers_utils_commonEnum__WEBPACK_IMPORTED_MODULE_5__["UserRole"].COMMERCIAL) {
                            url = 'prospection/commercial-prospect';
                            body = {
                                limit: this.limit,
                                skip: this.skip,
                                authorCode: userId,
                            };
                            this.prospectionProvider.getProspectByUserAuthor(url, body).subscribe(function (prospectionsList) {
                                if (!_this.prospections && !_this.prospectionsTmp) {
                                    _this.prospections = [];
                                    _this.prospectionsTmp = [];
                                    _this.positions = [];
                                }
                                _this.prospections = _this.prospections.concat(prospectionsList.slice());
                                _this.prospectionsTmp = _this.prospectionsTmp.concat(prospectionsList.slice());
                                _this.prospections = prospectionsList;
                            });
                        }
                        else {
                            body = {
    ...
    ProspectionPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-commercial-prospection-prospection-module-es5.js.map