...
let EmployeManagementPageModule = class EmployeManagementPageModule {
};
...
let EmployeManagementPage = class EmployeManagementPage {
    constructor(userProvider, session, observableProvider, config) {
    ...
    getEmplyeByFilter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.userProvider.save('user/employe/entity', body).subscribe((employes) => {
    ...
    getEmplyes() {
        ...
        this.userProvider.getAll(url).subscribe((employes) => {
            if (!this.employes && !this.employesTmp) {
                this.employes = [];
                this.employesTmp = [];
                this.positions = [];
...
EmployeManagementPage.ctorParameters = () => [
...
//# sourceMappingURL=pages-manager-employe-management-employe-management-module-es2015.js.map